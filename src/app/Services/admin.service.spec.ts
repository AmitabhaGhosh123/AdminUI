...
describe('AdminService', () => {
  ...
  describe('getUsers', () => {
    ...
    it('should return expected users (called once)', () => {
      ...
      adminService.getAllUsers().subscribe({
        next: users => expect(users).toEqual(expectedUsers, 'should return expected users'),
        error: fail,
      });

      // adminService should have made one request to GET users from expected URL
      const req = httpTestingController.expectOne(adminService.adminEndPointUrl + '/members.json');
